                ...
                <div class="product ftco-animate">
                    <div class="img d-flex align-items-center justify-content-center"
                        ...
                        <div class="desc">
                            <p class="meta-prod d-flex">
                                ...
                                <a href="{{ route('store.product', $item->id) }}"
                    ...
                    <div class="text text-center">
                        ...
                        <p class="mb-0">
                            ...
                            <span class="price">{{ number_format($item->price - ($item->price * $item->sale / 100)) }}
                                VNĐ</span></p>
                        @else
                        ...
                        <div class="testimony-wrap py-4">
                            ...
                            <div class="text">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="user-img"
                                        style="background-image: url({{ Storage::url($brand->image) }})"></div>
                                    <div class="pl-3">
            ...
            <div class="row d-flex">
                ...
                <div class="col-lg-6 d-flex align-items-stretch ftco-animate">
                    <div class="blog-entry d-flex">
                        ...
                        <h3 class="heading mb-3"><a href="{{ route('store.blog', $blog->id) }}">{{ $blog->name }}</a>
                        </h3>
                        <p>{{ $blog->sub_des }}
                        </p>
                        <a href="{{ route('store.blog', $blog->id) }}" class="btn-custom">Đọc thêm <span
                                class="fa fa-long-arrow-right"></span></a>
