...
@endif
<form class="row kt-form" method="POST" enctype="multipart/form-data" action="{{ route("manager.brands.update", $data->id) }}">
    @csrf
    <div class="col-md-4">
            ...
            <div class="kt-portlet__body">
                <div class="kt-section kt-section--first">
                    ...
                    <label class="kt-section__body">
                        <img width="100%" src="{{ Storage::url($data->image) }}" id="review-img"/>
