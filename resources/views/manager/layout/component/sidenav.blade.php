<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
        <ul class="kt-menu__nav">
            <li class="kt-menu__item @if (url()->current() == route("manager.dashboard")) kt-menu__item--active @endif" aria-haspopup="true"><a href="{{ route('manager.dashboard') }}" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
            ...
            @if (auth()->user()->is_SuperAdmin)
                <li class="kt-menu__item @if (Str::contains(url()->current(), 'account')) kt-menu__item--active @endif" aria-haspopup="true">
                    <a href="{{ route("manager.account") }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                    ...
                    <span class="kt-menu__link-text">Quản lý người dùng</span></a>
                </li>
            @endif

            <li class="kt-menu__item @if (Str::contains(url()->current(), '/categories')) kt-menu__item--active @endif" aria-haspopup="true">
                <a href="{{ route("manager.categories") }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <span class="kt-menu__link-text">Loại sản phẩm</span></a>
            </li>

            <li class="kt-menu__item @if (Str::contains(url()->current(), 'sub-categories')) kt-menu__item--active @endif" aria-haspopup="true">
                <a href="{{ route("manager.sub-categories") }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24"/>
                        <path d="M4.5,3 L19.5,3 C20.3284271,3 21,3.67157288 21,4.5 L21,19.5 C21,20.3284271 20.3284271,21 19.5,21 L4.5,21 C3.67157288,21 3,20.3284271 3,19.5 L3,4.5 C3,3.67157288 3.67157288,3 4.5,3 Z M8,5 C7.44771525,5 7,5.44771525 7,6 C7,6.55228475 7.44771525,7 8,7 L16,7 C16.5522847,7 17,6.55228475 17,6 C17,5.44771525 16.5522847,5 16,5 L8,5 Z" fill="#000000"/>
                ...
                <span class="kt-menu__link-text">Loại sản phẩm con</span></a>
            </li>

            <li class="kt-menu__item @if (Str::contains(url()->current(), '/sizes')) kt-menu__item--active @endif" aria-haspopup="true">
                <a href="{{ route("manager.sizes") }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24"/>
                        <path d="M4.5,3 L19.5,3 C20.3284271,3 21,3.67157288 21,4.5 L21,19.5 C21,20.3284271 20.3284271,21 19.5,21 L4.5,21 C3.67157288,21 3,20.3284271 3,19.5 L3,4.5 C3,3.67157288 3.67157288,3 4.5,3 Z M8,5 C7.44771525,5 7,5.44771525 7,6 C7,6.55228475 7.44771525,7 8,7 L16,7 C16.5522847,7 17,6.55228475 17,6 C17,5.44771525 16.5522847,5 16,5 L8,5 Z" fill="#000000"/>
