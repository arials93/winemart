...
@include('manager.layout.component.subheader', ['main_text' => 'Danh sách loại sản phẩm', 'btn_url' =>
route('manager.categories.create'), 'btn_text' => 'Thêm loại sản phẩm'])
@endsection
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="kt-section__content">
                                    <a href="{{ route('manager.categories.edit', $cate->id) }}" class="btn btn-info"><i
                                    ...
                                    <div class="modal fade" id="kt_modal_1_{{ $cate->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <form class="modal-content" method="POST"
                                                action="{{ route("manager.categories.delete", $cate->id) }}">
                                                @csrf
